...
import type { CalendarEvent, Event } from '../../src/types.ts';
...
async function exportData() {
  ...
  for (const event of eventResp) {
    ...
    if (event.featured_image_ref) {
      exportedEvents.push({
        ...
        featuredText: event.featured_text,
      });
    }
  }
  ...
  //       {
  //     "id": "3073",
  //     "title": "Nationale Boulder Wedstrijd",
  //     "date": "2025-10-25T00:00:00+00:00",
  //     "startTimeUtc": "2025-10-24T22:00:00+00:00",
  //     "endTimeUtc": "2025-10-25T21:59:59+00:00",
  //     "timezone": "Europe\/Amsterdam",
  //     "venueName": "Revolt Bouldering Gym, Delft",
  //     "venueImage": "https:\/\/www.klimkalender.nl\/wp-content\/uploads\/2024\/07\/variant.jpg",
  //     "venueAddress": "Kleveringweg 35, 2616 LZ, Delft, Netherlands",
  //     "link": "https:\/\/was.nkbv.nl\/competitions\/4765",
  //     "tags": [
  //         "BOULDER",
  //         "NKBV"
  //     ],
  //     "featured": true,
  //     "featuredImage": "https:\/\/www.klimkalender.nl\/wp-content\/uploads\/2025\/10\/Feed_NationaleBoulderWedstrijd-scaled.jpg",
  //     "featuredText": "\nOnderstaande informatie is automatisch overgenomen uit het Wedstrijdadministratiesysteem (WAS) van de NKBV. Let op: kijk voor de meest actuele informatie altijd op het WAS via de link bij deze wed..."
  // },
